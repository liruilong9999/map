...
class tile_value final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:mapnik.vector.tile.value) */ {
 public:
  tile_value();
  virtual ~tile_value();
...
class tile_feature final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:mapnik.vector.tile.feature) */ {
 public:
  tile_feature();
...
class tile_layer final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:mapnik.vector.tile.layer) */ {
 public:
  tile_layer();
  virtual ~tile_layer();
...
class tile final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:mapnik.vector.tile) */ {
 public:
  tile();
  virtual ~tile();
